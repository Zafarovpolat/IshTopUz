export const translations = {
  en: {
    ...
    hero: {
      ...
      subtitle: "Forget the old rules. You can have the best people. Right now. Right here.",
      getStarted: "Get Started",
      trustedBy: "Trusted by",
      imageAlt: "Freelancers collaborating",
    },
    benefits: {
        title: "Why Choose IshTop.Uz?",
        subtitle: "The best features for freelancers and clients in Uzbekistan.",
        paymentGuarantee: {
    ...
    faq: {
        ...
        subtitle: "Find answers to common questions about IshTop.Uz.",
        q1: "What is IshTop.Uz?",
        a1: "IshTop.Uz is the first freelance marketplace in Uzbekistan, designed to connect talented freelancers with clients for secure and efficient project collaboration.",
        q2: "How does the payment guarantee work?",
        a2: "We use an escrow system. The client's payment is held securely in an account and is only released to the freelancer once the work is completed and approved by the client.",
        q3: "What is the commission fee?",
        a3: "IshTop.Uz charges a flat 5% commission on all transactions, which is significantly lower than most other international platforms. This means more of your earnings stay with you.",
        q4: "Which payment methods are supported?",
        a4: "The platform will support popular local payment systems, including HUMO and Payme, for seamless and convenient transactions.",
        q5: "When will the platform launch?",
        a5: "We are currently in the beta testing phase. Sign up for our newsletter to receive exclusive updates and be the first to know when we officially launch!",
    },
    contact: {
        title: "Join the Beta",
        subtitle: "Be the first to know when IshTop.Uz launches. Sign up for exclusive access.",
        form: {
            name: {
                label: "Full Name",
        ...
        toast: {
            ...
            failDescription: "Please check your input and try again.",
        }
    },
    cta: {
        title: "Ready to start your freelance journey?",
        subtitle: "Join IshTop.Uz! Sign up for beta testing and start earning or finding top talent in Uzbekistan.",
        button: "Sign Up Now",
    },
    footer: {
        description: "Uzbekistan’s first freelance marketplace designed for secure and efficient collaboration.",
        forClients: {
            title: "For Clients",
  ...
  uz: {
    ...
    hero: {
      title: "Ish qanday ishlashi kerak.",
      subtitle: "Eski qoidalarni unuting. Siz eng yaxshi odamlarga ega bo'lishingiz mumkin. Hozir. Shu yerda.",
      getStarted: "Boshlash",
      trustedBy: "Bizga ishonadilar",
