...
// ✅ Убрали userId из props
export function PortfolioForm({ onFormSubmit }: { onFormSubmit: () => void }) {
  ...
  const handleImageUpload = async (
    ...
    // ✅ Используем uuidv4() вместо userId для пути — безопаснее
    const storageRef = ref(storage, `portfolio/${uuidv4()}/${fileName}`);
  ...
  const onSubmit = (data: PortfolioFormValues) => {
    startTransition(async () => {
      // ✅ Убрали userId — получается на сервере
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input
                  placeholder="Дизайн мобильного приложения для финтеха"
                  {...field}
                />
              </FormControl>
              <FormMessage />
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Textarea
                  placeholder="Опишите задачу, процесс и результат работы..."
                  rows={4}
                  {...field}
                />
              </FormControl>
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              ...
              <FormControl>
                <Input placeholder="Figma, UI/UX, Prototyping" {...field} />
              </FormControl>
              <FormDescription>
                Перечислите ключевые технологии через запятую.
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
