    ...
    return (
      <div className="flex flex-col items-center justify-center rounded-lg border-2 border-dashed border-muted-foreground/20 p-12 text-center">
        <h3 className="text-xl font-semibold tracking-tight">
          Ваше портфолио пока пусто
        </h3>
        <p className="mt-2 text-sm text-muted-foreground">
          Добавьте свои лучшие работы, чтобы продемонстрировать свои навыки
          клиентам.
        </p>
      </div>
    );
              ...
              <AlertDialog>
                ...
                <AlertDialogContent>
                  <AlertDialogHeader>
                    ...
                    <AlertDialogDescription>
                      Это действие нельзя будет отменить. Эта работа будет
                      навсегда удалена из вашего портфолио.
                    </AlertDialogDescription>
                  </AlertDialogHeader>
                  <AlertDialogFooter>
