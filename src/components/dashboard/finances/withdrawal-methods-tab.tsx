...
export function WithdrawalMethodsTab() {
  return (
            ...
            <CardHeader>
                <div className="flex items-center justify-between">
                    <div>
                        ...
                        <CardDescription>Управляйте вашими банковскими картами и счетами.</CardDescription>
                    </div>
                     <Dialog>
                        ...
                        <DialogContent className="sm:max-w-[425px]">
                            <DialogHeader>
                            <DialogTitle>Новый метод вывода</DialogTitle>
                            </DialogHeader>
            ...
            <CardContent className="space-y-4">
                {withdrawalMethods.length > 0 ? (
                    withdrawalMethods.map((method) => (
                        <div key={method.id} className="flex items-center justify-between rounded-lg border p-4">
                            ...
                            <div className="flex items-center gap-2">
                                {!method.isPrimary && <Button variant="ghost" size="sm">Сделать основным</Button>}
                    ...
                    <div className="text-center text-muted-foreground py-8">
                        У вас нет добавленных методов для вывода средств.
                    </div>
                )}
            </CardContent>
        </Card>
...
function CreditCardIcon({ type }: { type: string }) {
    if (type === 'HUMO') {
        return <div className="rounded-md bg-blue-100 p-2 text-blue-600">HUMO</div>
    }
    if (type === 'Uzcard') {
         return <div className="rounded-md bg-green-100 p-2 text-green-600">Uzcard</div>
    }
